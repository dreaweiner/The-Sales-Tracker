...
namespace The_Sales_Tracker.Utilities
{
    /// <summary>
    ...
    class ConsoleUtil
    {
        ...
        private static ConsoleColor _headerForegroundColor = ConsoleColor.DarkMagenta;

        private static ConsoleColor _bodyBackgroundColor = ConsoleColor.Black;
        private static ConsoleColor _bodyForegroundColor = ConsoleColor.Magenta;
        ...
        {
            get { return _headerForegroundColor = ConsoleColor.DarkMagenta; }
            set { _headerForegroundColor = value; }
        }

        public static ConsoleColor BodyBackgroundColor
        {
            get { return _bodyBackgroundColor = ConsoleColor.Gray; }
            set { _bodyBackgroundColor = value; }
        }

        public static ConsoleColor BodyForegroundColor
        {
            get { return _bodyForegroundColor = ConsoleColor.DarkMagenta; }
